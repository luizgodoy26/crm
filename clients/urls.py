...
from .views import client_company_list, client_person_list, new_client_company, new_client_person, edit_client_company, edit_client_person, delete_client_company, delete_client_person
